...
KEYWORDS =: ;: 'procedure class constructor function method field static var int char boolean void true false null this let do if else while return'
...
IsOp =: 3 : 0
  (TokenIs '+') +. (TokenIs '-') +. (TokenIs '*') +. (TokenIs '/') +. (TokenIs '&amp;') +. (TokenIs '|') +. (TokenIs '&lt;') +. (TokenIs '&gt;') +. (TokenIs '=')+. (TokenIs '$')
)
...
CompileClass =: 3 : 0
  ...
  while. (TokenIs 'constructor') +. (TokenIs 'function') +. (TokenIs 'method')  +. (TokenIs 'procedure') do.
...
CompileDo =: 3 : 0
  if. NextTokenIs '{' do.
    out =. y TagLine '<doWhileStatement>'
    ...
    out =. out , y TagLine '</doWhileStatement>'
